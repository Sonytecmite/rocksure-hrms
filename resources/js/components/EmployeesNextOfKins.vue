<template>
    <div class="container pt-4">
        <div class="row justify-content-center">
            <div class="col-md-12">
                <h3 class="page-title">Employee Next of Kin</h3>
            </div>
        </div>
                ...
                <div class="col-md-8">
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <input v-model="form.relationship" id="relationship" type="text" name="relation" required  class="form-control" :class="{ 'is-invalid': form.errors.has('relationship') }">
                            <has-error :form="form" field="relationship"></has-error>
                        </div>
                        <div class="form-group col-md-6">
                            <label for="hometown">Home Town <sup class="red">*</sup></label>
            ...
            <div class="row line">
                ...
                <div class="col-md-8 mb-3 mt-1">
                    <button type="submit" class="btn btn-large btn-primary mt-3">
                        Save Employee's Next of Kin Info
                    </button>
                </div>
            </div>
        </form>
